...
Pada hasil akurasi (F-Score) tabel tersebut, dapat terlihat bahwa pada fitur F1, tujuh dari sepuluh (70\%) buah kata memiliki nilai performa diatas baseline, enam dari sepuluh kata (60\%) diatas baseline pada fitur F2, tujuh dari sepuluh kata (70\%) diatas baseline pada fitur F3, dan delapan dari sepuluh kata (80\%) diatas baseline pada fitur F4. Grafik perbandingan dari fitur-fitur tersebut dapat dilihat pada gambar berikut. 
