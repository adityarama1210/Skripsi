...
Proses pertama yang dilakukan adalah memisahkan kalimat bahasa Inggris dan bahasa Indonesia dari korpus identik menjadi dua buah \textit{file} paralel untuk dapat diproses pada tahap-tahap berikutnya. Bentuk dari korpus identik tersebut adalah setiap \textit{instance} kalimat direpresentasikan dalam satu baris, dimana baris tersebut mengandung id unik, kalimat berbahasa Indonesia, dan kalimat berbahasa Inggris yang dipisahkan oleh tab.
...
Korpus yang dihasilkan setelah proses ini adalah dua buah korpus (korpus bahasa Indonesia, dan korpus bahasa Inggris) dimana masing-masing baris adalah kalimat yang saling berpasangan.
...
Proses evaluasi meliputi \textit{pre-processing}, anotasi data, dan evaluasi.
